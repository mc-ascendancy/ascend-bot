...
text_1 = discord.Embed(
    title="Whether you’re from the communities of Minecraft "
...
text_2 = discord.Embed(
    title="<#734098917867782214>: Where all these embeds are posted and will "
...
text_3 = discord.Embed(
    title="<#734122828613288059>: A Hall of Fame for your genius feature "
...
text_4 = discord.Embed(
    title="<#734099995392868352>: A channel for those who prefer to text "
          "chat.\n"
...
text_5 = discord.Embed(
    title="The leadership hierarchy of this Discord, as well as the "
...
text_6 = discord.Embed(
    title="<@&734418804490240061>s are extremely generous members of our community "
...
text_7 = discord.Embed(
    title="<@&734096990396350515>s are the backbone of our community… indeed, "
...
text_8 = discord.Embed(
    title="We want Ascendancy to develop in a productive and positive way. "
...
text_9 = discord.Embed(
    title="Don't like a prospective feature? Having doubts about the "
...
text_10 = discord.Embed(
    title="Don't be obnoxious. You know exactly what we mean by this rule, "
...
text_11 = discord.Embed(
    title="You want to dominate? Sure, go ahead: the consequences of being "
...
text_12 = discord.Embed(
    title="Don't promote yourself and your services or other products and "
...
text_13 = discord.Embed(
    title="Don't be rude. Don't spam. If you are uncertain where a message "
